...
SWIGINTERN void JsPortBuffer_dumpBuffer(JsPortBuffer *self,char *buffer){
...
static int _wrap_JsPortBuffer_dumpBuffer(lua_State* L) {
  int SWIG_arg = 0;
  JsPortBuffer *arg1 = (JsPortBuffer *) 0 ;
  char *arg2 = (char *) 0 ;
  
  SWIG_check_num_args("JsPortBuffer::dumpBuffer",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JsPortBuffer::dumpBuffer",1,"JsPortBuffer *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("JsPortBuffer::dumpBuffer",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JsPortBuffer,0))){
    SWIG_fail_ptr("JsPortBuffer_dumpBuffer",1,SWIGTYPE_p_JsPortBuffer);
  }
  ...
  arg2 = (char *)lua_tostring(L, 2);
  {
    char *err;
    clear_exception();
    JsPortBuffer_dumpBuffer(arg1,arg2);
    if ((err = check_exception())) {
      luaL_error(L, err);
      return -1; 
...
static swig_lua_method swig_JsPortBuffer_methods[] = {
    ...
    {"dumpBuffer", _wrap_JsPortBuffer_dumpBuffer}, 
...
static swig_lua_const_info swig_constants[] = {
    {SWIG_LUA_CONSTTAB_INT("PROCESS", PROCESS)},
    {SWIG_LUA_CONSTTAB_INT("SESSION", SESSION)},
    {SWIG_LUA_CONSTTAB_INT("ERR", ERR)},
    {SWIG_LUA_CONSTTAB_INT("SAMPLE_RATE_CHANGE", SAMPLE_RATE_CHANGE)},
    {SWIG_LUA_CONSTTAB_INT("SHUTDOWN", SHUTDOWN)},
    {SWIG_LUA_CONSTTAB_INT("JackTransportStopped", JackTransportStopped)},
    {SWIG_LUA_CONSTTAB_INT("JackTransportRolling", JackTransportRolling)},
    {SWIG_LUA_CONSTTAB_INT("JackTransportLooping", JackTransportLooping)},
    {SWIG_LUA_CONSTTAB_INT("JackTransportStarting", JackTransportStarting)},
    {SWIG_LUA_CONSTTAB_INT("JackPortIsInput", JackPortIsInput)},
    {SWIG_LUA_CONSTTAB_INT("JackPortIsOutput", JackPortIsOutput)},
    {SWIG_LUA_CONSTTAB_INT("JackPortIsPhysical", JackPortIsPhysical)},
    {SWIG_LUA_CONSTTAB_INT("JackPortCanMonitor", JackPortCanMonitor)},
    {SWIG_LUA_CONSTTAB_INT("JackPortIsTerminal", JackPortIsTerminal)},
    {SWIG_LUA_CONSTTAB_INT("JackNullOption", JackNullOption)},
    {SWIG_LUA_CONSTTAB_INT("JackNoStartServer", JackNoStartServer)},
    {SWIG_LUA_CONSTTAB_INT("JackUseExactName", JackUseExactName)},
    {SWIG_LUA_CONSTTAB_INT("JackServerName", JackServerName)},
    {SWIG_LUA_CONSTTAB_INT("JackLoadName", JackLoadName)},
    {SWIG_LUA_CONSTTAB_INT("JackLoadInit", JackLoadInit)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionID", JackSessionID)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionSave", JackSessionSave)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionSaveAndQuit", JackSessionSaveAndQuit)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionSaveTemplate", JackSessionSaveTemplate)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionSaveError", JackSessionSaveError)},
    {SWIG_LUA_CONSTTAB_INT("JackSessionNeedTerminal", JackSessionNeedTerminal)},
    {SWIG_LUA_CONSTTAB_INT("JackCaptureLatency", JackCaptureLatency)},
    {SWIG_LUA_CONSTTAB_INT("JackPlaybackLatency", JackPlaybackLatency)},
    {0,0,0,0,0,0}
};
