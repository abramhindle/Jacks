...
SWIGINTERN PyObject *_wrap_JsPortBuffer_dumpBuffer(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  JsPortBuffer *arg1 = (JsPortBuffer *) 0 ;
  char *arg2 = (char *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:JsPortBuffer_dumpBuffer",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_JsPortBuffer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "JsPortBuffer_dumpBuffer" "', argument " "1"" of type '" "JsPortBuffer *""'"); 
  }
  arg1 = (JsPortBuffer *)(argp1);
  res2 = SWIG_AsCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "JsPortBuffer_dumpBuffer" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = (char *)(buf2);
  {
    char *err;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"JsPortBuffer_dumpBuffer", _wrap_JsPortBuffer_dumpBuffer, METH_VARARGS, NULL},
